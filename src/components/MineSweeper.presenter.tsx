...
import { IPropsMineSweeperUI } from "./MineSweeper.types";
  ...
  return (
    <div className="minesweeper">
      ...
      <div className="field_container">
        {props.field?.map((data, yIndex) => (
          <div className="tile_container" key={yIndex}>
            {data.map((data, xIndex) => (
              <Fragment key={xIndex}>
                {data.isOpen ? (
                  <>
                    {data.value === MINE ? (
                      <span
                        ...
                        onContextMenu={props.onContextMenuTile(xIndex, yIndex)}
                      >
                        {data.value}
                      </span>
                    ) : (
